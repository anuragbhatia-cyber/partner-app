...
const sections: Section[] = [
  {
    ...
    screens: [
      ...
      { path: "/onboarding", title: "Onboarding Welcome", desc: "Preview 5 steps" },
      ...
      { path: "/onboarding/bank", title: "Bank Details", desc: "Payout account" },
      { path: "/onboarding/agreement", title: "Partner Agreement", desc: "T&C + consent" },
